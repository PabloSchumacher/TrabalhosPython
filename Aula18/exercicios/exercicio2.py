...
print(f'frutas: {lista[1][2:5:2]} - verduras: {lista[2][2:5:2]} legumes: {lista[3][1:6:3]} {lista[3][5]}')
...
print(f'fruta: 3kg de {lista[1][2]} - 8kg de uva {lista[1][3]} - 4.5kg de {lista[1][5]} - 1kg de {lista[1][6]}')
...
print(f'verduras: 5 maço de {lista[2][5]}, 4 pés de {lista[2][2]} e {lista[2][0]}, 2 cabeças de {lista[2][4]}')

print('9: imprima com f-string a seguinte sequência: legumes: 1kg de feijão, 2kg de gão de bico, 1.5 kg dde soja,'
      '1 pacote de ervilha')
print(f'legumes: 1kg de {lista[3][0]}, 2kg de {lista[3][5]}, 1.5kg de {lista[3][6]} e 1 pacote de {lista[3][1]}')
